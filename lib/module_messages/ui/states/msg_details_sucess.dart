...
class MsgDetailsSuccess extends States {
  final MsgModel?  detailsModel;
  final MsgDetailsScreenState screenState;

  MsgDetailsSuccess( this.screenState,{ this.detailsModel,} ) : super(screenState);
        ...
        children: [
          CustomContainer(Padding(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ListTile(title: Text(detailsModel!.title ),subtitle:  Text(detailsModel!.text ),
                  trailing: Text(detailsModel!.date ),),
