...
import '../module_auth/ui/screen/login_screen/signup_screen.dart' as _i48;
import '../module_change_pass/manager/change_pass_manager.dart' as _i32;
import '../module_change_pass/pass_module.dart' as _i59;
...
import '../module_change_pass/state_manager/chnage_pass_state_manager.dart'
    as _i37;
import '../module_change_pass/ui/screen/chnage_pass_screen.dart' as _i53;
import '../module_emploees/employee_module.dart' as _i60;
import '../module_emploees/repository/employees_repository.dart' as _i19;
import '../module_emploees/service/employee_service.dart' as _i38;
import '../module_emploees/state_manager/emplo_state_manager.dart' as _i39;
import '../module_emploees/ui/screen/add_employe.dart' as _i50;
import '../module_emploees/ui/screen/emp_record_screen.dart' as _i54;
import '../module_emploees/ui/screen/employees_screen.dart' as _i40;
import '../module_invoices/invoice_module.dart' as _i56;
...
import '../module_invoices/state_manager/invoice_state_manager.dart' as _i41;
import '../module_invoices/ui/admin_invoices_screen.dart' as _i3;
import '../module_invoices/ui/screen/add_invoice_screen.dart' as _i51;
import '../module_invoices/ui/screen/invoice_details_screen.dart' as _i55;
import '../module_invoices/ui/screen/invoices_screen.dart' as _i57;
import '../module_localization/presistance/localization_preferences_helper/localization_preferences_helper.dart'
    as _i7;
import '../module_localization/service/localization_service/localization_service.dart'
    as _i8;
import '../module_mails/mail_module.dart' as _i44;
...
import '../module_mails/ui/screen/add_mail_screen.dart' as _i36;
import '../module_mails/ui/screen/mail_details_screen.dart' as _i43;
import '../module_mails/ui/screen/mails_list_screen.dart' as _i45;
...
import '../module_messages/messages_module.dart' as _i58;
...
import '../module_messages/ui/messages_screen.dart' as _i47;
import '../module_messages/ui/msg_details_screen.dart' as _i46;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i34.SignUpStateManager>(
      () => _i34.SignUpStateManager(get<_i17.AuthService>()));
  gh.factory<_i35.SplashScreen>(
      () => _i35.SplashScreen(get<_i17.AuthService>()));
  gh.factory<_i36.AddMailScreen>(
      () => _i36.AddMailScreen(get<_i26.MailsStateManager>()));
  gh.factory<_i37.ChangePassStateManager>(() => _i37.ChangePassStateManager(
      get<_i17.AuthService>(), get<_i33.PasswordService>()));
  gh.factory<_i38.EmployeeService>(
      () => _i38.EmployeeService(get<_i19.EmployeesRepository>()));
  gh.factory<_i39.EmployeeStateManager>(
      () => _i39.EmployeeStateManager(get<_i38.EmployeeService>()));
  gh.factory<_i40.EmployeesScreen>(
      () => _i40.EmployeesScreen(get<_i39.EmployeeStateManager>()));
  gh.factory<_i41.InvoiceStateManager>(() => _i41.InvoiceStateManager(
  ...
  gh.factory<_i43.MailDetailsScreen>(
      () => _i43.MailDetailsScreen(get<_i26.MailsStateManager>()));
  gh.factory<_i44.MailModule>(() => _i44.MailModule(
      get<_i36.AddMailScreen>(), get<_i43.MailDetailsScreen>()));
  gh.factory<_i45.MailsListScreen>(
      () => _i45.MailsListScreen(get<_i26.MailsStateManager>()));
  gh.factory<_i46.MsgDetailsScreen>(
      () => _i46.MsgDetailsScreen(get<_i30.MsgStateManager>()));
  gh.factory<_i47.MsgScreen>(() => _i47.MsgScreen(get<_i30.MsgStateManager>()));
  gh.factory<_i48.SignUpScreen>(
      () => _i48.SignUpScreen(get<_i34.SignUpStateManager>()));
  gh.factory<_i49.SplashModule>(
      () => _i49.SplashModule(get<_i35.SplashScreen>()));
  gh.factory<_i50.AddEmployeeScreen>(
      () => _i50.AddEmployeeScreen(get<_i39.EmployeeStateManager>()));
  gh.factory<_i51.AddInvoiceScreen>(
      () => _i51.AddInvoiceScreen(get<_i41.InvoiceStateManager>()));
  gh.factory<_i52.AuthorizationModule>(() => _i52.AuthorizationModule(
      get<_i42.LoginScreen>(), get<_i48.SignUpScreen>()));
  gh.factory<_i53.ChangePassScreen>(
      () => _i53.ChangePassScreen(get<_i37.ChangePassStateManager>()));
  gh.factory<_i54.EmployeeRecordScreen>(
      () => _i54.EmployeeRecordScreen(get<_i39.EmployeeStateManager>()));
  gh.factory<_i55.InvoiceDetailsScreen>(
      () => _i55.InvoiceDetailsScreen(get<_i41.InvoiceStateManager>()));
  gh.factory<_i56.InvoiceModule>(() => _i56.InvoiceModule(
      get<_i51.AddInvoiceScreen>(), get<_i55.InvoiceDetailsScreen>()));
  gh.factory<_i57.InvoiceScreen>(
      () => _i57.InvoiceScreen(get<_i41.InvoiceStateManager>()));
  gh.factory<_i58.MessageModule>(() =>
      _i58.MessageModule(get<_i47.MsgScreen>(), get<_i46.MsgDetailsScreen>()));
  gh.factory<_i59.ChangePassModule>(
      () => _i59.ChangePassModule(get<_i53.ChangePassScreen>()));
  gh.factory<_i60.EmployeeModule>(() => _i60.EmployeeModule(
      get<_i50.AddEmployeeScreen>(),
      get<_i40.EmployeesScreen>(),
      get<_i54.EmployeeRecordScreen>()));
  gh.factory<_i61.MyApp>(() => _i61.MyApp(
      ...
      get<_i59.ChangePassModule>(),
      get<_i56.InvoiceModule>(),
      get<_i44.MailModule>(),
      get<_i58.MessageModule>(),
      get<_i60.EmployeeModule>()));
  return get;
}
